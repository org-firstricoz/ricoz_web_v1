export default function OurHistory() {
  return (
    <div className="flex px-40 py-24 gap-16">
      <img src="fp4.png" className="w-[30rem]" alt="" />
      <div className="text-black flex flex-col gap-8">
        <h3 className="playfair-display text-3xl font-semibold">Our History</h3>
        ...
        <div className="flex gap-8 items-center ">
            ...
            <div className="text-sm text-black/50">Duis aute irure dolor in reprehenderit in the voluptate velit esse cillum dolore eu ugiat nulla pariatur cupiat non proident.</div>
        </div>
        <div className="flex gap-8 items-center">
